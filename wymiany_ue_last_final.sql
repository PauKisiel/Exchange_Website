...
--
-- Host: 127.0.0.1
-- Czas generowania: 06 Lut 2019, 14:09
...
CREATE TABLE `organizacje` (
  ...
  `logo` text CHARACTER SET utf32 COLLATE utf32_polish_ci NOT NULL,
...
--
ALTER TABLE `organizacje`
  MODIFY `id_organizacji` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `zapis`
  MODIFY `id_zapisu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
