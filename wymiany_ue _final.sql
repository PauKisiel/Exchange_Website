...
--
-- Host: 127.0.0.1
-- Czas generowania: 05 Lut 2019, 13:34
...
CREATE TABLE `organizacje` (
  ...
  `haslo` varchar(30) CHARACTER SET utf32 COLLATE utf32_polish_ci NOT NULL,
...
INSERT INTO `organizacje` (`id_organizacji`, `nazwa`, `kraj`, `e_mail`, `telefon`, `opis`, `haslo`, `czy_aktywna`) VALUES
...
INSERT INTO `zapis` (`id_zapisu`, `id_uzytkownika`, `id_wymiany`, `data_zapisu`, `czy_zatwierdzony`) VALUES
(1, 1, 4, '2019-02-05', 1);
...
--
ALTER TABLE `organizacje`
  MODIFY `id_organizacji` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `zapis`
  MODIFY `id_zapisu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
